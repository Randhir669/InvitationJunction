...
export default function Banner() {
    ...
    return (
        <>
            <div className="bg-emerald-100 text-black py-2 text-center z-50">
                ...
                <div className="flex justify-between items-center mx-auto max-w-7xl">
                    <div className="flex items-center space-x-4">
                        <div className="flex items-center">
                            ...
                            <span className="ml-2 font-bold underline">123-456-7890</span>
                        </div>
                    </div>
                    <div className="flex items-center space-x-4">
                        {/* Add your social media icons here */}
                        <a href="https://wa.me/918509332134?text=I%20Want%20to%20Buy%20Invitation%20Card%20From%20Your%20Website%20Kindly%20send%20me%20the%20Details?" className="text-black ">
